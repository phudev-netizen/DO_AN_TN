...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th5 21, 2025 lúc 03:01 PM
...
(33,'https://i.postimg.cc/qqbFg3yT/ban-phim-co-dareu-ek87-white-usb-led-xanh-0000-1.jpg', 1, 7),
(34,'https://i.postimg.cc/kXjCtVqD/deeb4f049d14ffe3f06e55d481a99f71.png', 0, 7),
(35,'https://i.postimg.cc/FRxMNFvX/nghe.jpg',0,7),
(36,'https://i.postimg.cc/Vkb25WwR/OIP.jpg',0,7),
(37,'https://i.postimg.cc/mrYqyZt1/ram-2-1655868000270.jpg',0,7);
...
(7, 'Laptop gaming MSI Stealth 16 AI Studio A1VHG 241VN', 2, 'Intel® Core™ Ultra 9 processor 185H with Intel® AI', 'RAM: 64GB', 'NVIDIA® GeForce RTX™', 'SSD: 1TB', '16\" QHD+(2560x1600), 240Hz', 1, 73990000, 10, 'Chiếc laptop gaming được trang bị con chip Intel Core Ultra 9 - 185H với 16 lõi, 22 luồng kết hợp với VGA NVIDIA GeForece RTX 4070 giúp trải nghiệm chơi các game AAA và render hình ảnh, video một cách mượt mà không xảy ra hiện tượng giật lag. \r\n\r\n', 1);
-- --------------------------------------------------------
...
--
ALTER TABLE `chitiethoadonban`
  MODIFY `MaChiTietHoaDonBan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=81;
...
--
ALTER TABLE `giohang`
  MODIFY `MaGioHang` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=229;
...
--
ALTER TABLE `hoadonban`
  MODIFY `MaHoaDonBan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=59;
